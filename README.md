...
- 사용자의 자세 및 착석형태에 따른 real-time data를 31개의 cell-sensor를 통하여 실시간으로 받아들이고 이를 압력값에 따라 다른 색상(남색,보라색,자주색,핑크색,빨강색)의 가시화된 형태로 피드백을 준다. <br>
- 사용자의 착석데이터를 분석한 결과에 따라 착석형태를 판단하여 현재상태를 표시해준다. <br>
