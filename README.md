...
<img src = "https://user-images.githubusercontent.com/79950091/148927494-579f83d3-e8ae-4ec9-956a-529400c2f9b5.png"                   width= "200" height = "100"/>
...
- 사용자의 자세 및 착석형태에 따른 real-time data를 31개의 cell-sensor를 통하여 실시간으로 받아들이고 이를 압력값에 따라 다른 색상(남색,보라색,자주색,핑크색,빨강색)의 가시화된 형태로 피드백을 준다. <br><br>
- 사용자의 착석데이터를 분석한 결과에 따라 착석형태를 판단하여 현재상태를 표시해준다. <br><br>
